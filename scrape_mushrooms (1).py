...
from bs4 import BeautifulSoup # parseo HTML
...
# Algunas imagenes fallan al descargar, intentamos varias veces.
MAX_RETRIES = 3          
BACKOFF_BASE = 1.0       
...
# Descargamos la pagina y obtenemos el HTML. Se parsea con BeautifulSoup
...
# Comprobamos si la URL es una imagen descargable
...
# Descargar una imagen. Si falla, se reintenta
...
# Solo nos interesan imagenes de setas. Descartamos esporas, basidios, etc.
...
# Scrapeamos las imagenes desde las URLs definidas. 
...
# Obtenemos las imagenes que contienen el nombre de la seta en el alt
...
def main():
    ...
    with open(csv_path, "w", newline="", encoding="utf-8") as csv_file:
        ...
        for class_name in MUSHROOM_CLASSES:
            ...
            if not urls:
                print(f"[WARNING] No hay URLs configuradas para la clase {class_name}")
                continue
